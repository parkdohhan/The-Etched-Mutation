...
async function initApp() {
    ...
    if (urlParams.get('strata') === '1' && urlParams.get('memory')) {
        ...
        const alignmentResult = {
            ...
            alignment_bucket: getBucket(avgAlignment), // 단일 출처: math.js getBucket
        };
        function _hideAllUI() {
