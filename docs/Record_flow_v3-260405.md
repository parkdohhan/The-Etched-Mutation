...
> ⚠️ **폐기됨 (2026-08-07)** — 구현 착수 0회 상태로 `RECORD_v4_설계-260807.md`로 대체.
> 이본지층(7-16)·기억별 좌표계(7-27)·이어받기 형식(7-30) 이전 세계의 설계라 현행과 불일치.
> 역사 기록으로만 보존. 안전 시스템·장면 수 규칙 등 일부 원칙은 v4가 명시적으로 계승.
>
> 작성: 2026-04-04
